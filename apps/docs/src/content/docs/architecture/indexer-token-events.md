...
Docker services running and migrations applied (see the [indexer README](https://github.com/salazarsebas/stellar-explorer/blob/main/services/indexer/README.md)).
