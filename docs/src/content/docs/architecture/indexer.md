...
For full configuration options and setup instructions, see the [indexer README](https://github.com/salazarsebas/stellar-explorer/blob/main/indexer/README.md).
